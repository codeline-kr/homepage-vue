<template>
    <v-container id="contactus">
        <v-row class="text-center text-md-left">
            <v-col cols="12" md="4" data-aos="fade-up">
                <h3 class="mb-2 d-flex align-center justify-center justify-md-start primary--text font-weight-bold subtitle-1" color="primary">
                    <v-icon class="mr-2" color="primary">mdi-home-city-outline</v-icon>Contact Us
                </h3>
                <p class="mb-1">
                    sdlee@code-line.kr<br />
                    010-9421-1155
                </p>
